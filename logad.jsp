...
<body style=" background-image:url('images/12.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
                ...
                <div class="row" style="margin-top:70px;">
                    ...
                    <div class="col-sm-5">
                        <div style="height: 430px;width: 500px;border: 1px solid black;background-color: white;box-shadow: 0px 0px 30px 0px;">
                                <div class="col-sm-12 text-light bg-info text-center" style="font-size: 20px;">Log In</div>
                                <h3 class="ms-3 mt-2">Login/Sign in</h3>
                                <b class="ms-4" style="font-size: 14px;">Enter Admin Id</b>
                                <input type="text" name="mobilenumber" placeholder="Enter Admin Id" style="width: 85%;margin-left: 25px;border-radius: 20px;margin-top: 10px;padding: 5px;padding-left: 10px;"/>
                                <br/><br/>
                                ...
                                <br/><br/>
                                <center><input type="submit" value="LogIn" class="bg-info text-light" style="background-color:rgb(242, 84, 84);width: 80px;border-radius: 5px;"></center>
                                <br/>
