...
<body style=" background-image:url('images/5.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
    <form method="post" action="controller.jsp">
        <input type="hidden" name="page" value="landlordlogin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12"><img src="images/1.jpg" style="max-height:130px;margin-left: 20px;margin-top: 20px;"></div>
                </div>
                <div class="row" style="margin-top: 30px;">
                    <div class="col-sm-7"></div>
                    <div class="col-sm-5">
                        <div style="height: 430px;width: 500px;border: 1px solid black;background-color: white;box-shadow: 0px 0px 30px 0px;">
                                <div class="col-sm-12 text-light bg-dark text-center" style="font-size: 20px;">Log In</div>
                                ...
                                <br/><br/>
                                <center><input type="submit" value="LogIn" class="bg-dark text-light" style="background-color:rgb(242, 84, 84);width: 80px;border-radius: 5px;"></center>
                                <br/>
